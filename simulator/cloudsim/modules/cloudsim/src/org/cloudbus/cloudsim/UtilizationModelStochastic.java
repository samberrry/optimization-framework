...
public class UtilizationModelStochastic implements UtilizationModel {
    ...
    /** The history. */
    private Map<Long, Double> history;

    /**
     * Instantiates a new utilization model stochastic.
     */
    public UtilizationModelStochastic() {
	setHistory(new HashMap<Long, Double>());
    }
     ...
     */
    @Override
    public double getUtilization(long time) {
     ...
     * @return the history
     */
    protected Map<Long, Double> getHistory() {
	return this.history;
    }
     ...
     *        the history
     */
    protected void setHistory(Map<Long, Double> history) {
	...
	setHistory((Map<Long, Double>) ois.readObject());
	ois.close();
    }
