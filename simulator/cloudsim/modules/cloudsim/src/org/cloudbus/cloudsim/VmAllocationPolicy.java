 ...
 * commit of reservation of hosts: first, we reserve the host and, once commited
 * by the user, it is effectivelly allocated to he/she
 * 
...
public abstract class VmAllocationPolicy {
     ...
     * 
     * @param list
     *        Machines available in this Datacentre
     * 
     * @pre $none
     * @post $none
     */
    ...
    /**
     * Allocates a host for a given VM. The host to be allocated is the one that
     * was already reserved.
     * 
     * @param vm
     *        virtual machine which the host is reserved to
     * 
     ...
     * @post $none
     */
    public abstract Host getHost(int vmId);
