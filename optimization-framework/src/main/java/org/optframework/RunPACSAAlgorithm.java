...
public class RunPACSAAlgorithm {
    ...
    public static void main( String[] args )
    {
        ...
        PACSAParameters parameters = new PACSAParameters(populateSimpleWorkflow(1000, 0));

//        PACSAParameters parameters = new PACSAParameters(populateWorkflowFromDax(1000, 0));

        PACSAOptimization saAlgorithm = new PACSAOptimization(parameters);

        saAlgorithm.runAlgorithm();
